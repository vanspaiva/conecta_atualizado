...
<div class="py-4">
    <div class="row">
        <div class="col-md form-group ">
            <label class='control-label text-black'><b>Imagens da Análise</b> <span class="btn text-success px-2" data-toggle="modal" data-target="#verfotosB"><i class="fas fa-images"></i></span></label>
            <div class="d-flex justify-content-center p-2 border rounded bg-light">
                <div>
                    ...
                    <p class="uploader-conecta-button" id="widget2">
                        <input id="foto2" type="hidden" role="uploadcare-uploader" data-public-key="fe82618d53dc578231ce" data-tabs="file file gdrive dropbox" data-multiple="true" data-images-only="true" data-preview-step="true" data-crop />
                    </p>
                </div>
            </div>
