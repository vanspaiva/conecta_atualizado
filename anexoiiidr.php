...
?>
    ...
    if (isset($_SESSION["useruid"])) {
        ...
        while ($rowanexoiiidr = mysqli_fetch_array($retanexoiiidr)) {
            ...
            $statusQualidade = $rowanexoiiidr['xiiidrStatusQualidade'];
                    ...
                    <div class="row d-flex justify-content-center p-4">
                        <div class="col-md-10">
                            <div class="card">
                                <div class="card-body">
                                    <div class="form">
                                        <form action="includes/sendanexoiiidr.inc.php" method="POST">
                                            <div hidden>
                                            ...
                                            <div class="form-group">
                                                <div class="my-3 py-4">
                                                    ...
                                                    <p class="text-black">Por meio do presente termo, de livre e espontânea vontade, AUTORIZO a empresa fabricante CPMH do implante Sob Medida o uso de meus dados e qualquer outra informação que seja necessário para o processo junto a ANVISA, transitando os dados necessários e que os mesmos serão armazenados pela empresa e autorizo também o uso de minha imagem, livre de quaisquer ônus para a empresa fornecedora dos materiais cirúrgicos, CPMH – COMÉRCIO E INDÚSTRIA DE PRODUTOS MÉDICO–HOSPITALARES E ODONTOLÓGICOS LTDA, com o propósito de consulta profissional, pesquisas, literatura específica da área médica e mídias da empresa fabricante. Sendo de minha vontade, declaro a autorização do uso acima descrito sem nenhuma reclamação de direito. </p>
                                                    <h5 class="text-muted text-center pb-3"><b>Termo aditivo exclusivo para Produtos/Implantes Personalizados:</b></h5>
                                                    <p class="text-black">Declaro ainda, ter ciência de que um técnico habilitado em saúde (enfermeiro/instrumentador) da equipe CPMH poderá acompanhar a cirurgia a fim de prestar instruções quanto ao uso do implante Sob Medida. Para tanto, a data da cirurgia deverá ser informada com antecedência à CPMH para agendamento do técnico.</p>
                                                </div>
                                                <hr>
                                            </div>
