...
if (!empty($_GET)) {
    ...
    if (isset($_SESSION["useruid"]) && (($_SESSION["userperm"] == 'Qualidade')) || ($_SESSION["userperm"] == 'Administrador')) {
        ...
        $ret = mysqli_query($conn, "SELECT * FROM qualianexoiiipac WHERE xiiipacIdProjeto='" . $id . "';");
        while ($row = mysqli_fetch_array($ret)) {
            // $dataEHoraDoc  = explode(" ", $row['xiiidrData']);
            // $dataDoc = $dataEHoraDoc[0];
            $dataDoc = explode("-", $row['xiiipacData']);
            $dia = $dataDoc[2];
            $mes = $dataDoc[1];
            $ano = $dataDoc[0];
            $data = $dia . '/' . $mes . '/' . $ano;

            $nomepac = $row['xiiipacNomePac'];

            $status = $row['xiiipacStatusQualidade'];
...
?>
            ...
            <body class="bg-white" style="overflow-x: hidden;">
                        ...
                        <div class="col p-2">
                            <table style="width:100%; border: 1px solid #000;">
                                <tr style="border: 1px solid #000;">
                                    ...
                                    <td rowspan="2" class="text-center" style="font-weight: bold; font-size: 20px; border: 1px solid #000;">Procedimento do Sistema da Gestão da Qualidade FORM QUA Nº 037</td>
                                ...
                                <tr style="border: 1px solid #000;">
                                    <td colspan="3" class="text-center" style="font-weight: bold; font-size: 16px; border: 1px solid #000;">Anexo III - Paciente TERMO DE CONSENTIMENTO DE INFORMAÇÕES E IMAGENS</td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="p-3">
                                    ...
                                    <p style="text-align: justify;">Por meio do presente termo, de livre e espontânea vontade, AUTORIZO a empresa fabricante
                                        CPMH do implante Sob Medida o uso de meus dados e qualquer outra informação que seja
                                        necessário para o processo junto a ANVISA, transitando os dados necessários e que os
                                        mesmos serão armazenados pela empresa e autorizo também o uso de minha imagem,
                                        mantendo o sigilo da minha identidade, livre de quaisquer ônus para a empresa fornecedora
                                        dos materiais cirúrgicos, CPMH – COMÉRCIO E INDÚSTRIA DE PRODUTOS
                                        MÉDICO–HOSPITALARES E ODONTOLÓGICOS LTDA, com o propósito de consulta
                                        profissional, pesquisas, literatura específica da área médica e mídias da empresa fabricante.,
                                        sendo concedida à título gratuito. Sendo de minha vontade, declaro a autorização do uso acima
                                        descrito sem nenhuma reclamação de direitos, podendo o cirurgião responsável também fazer
                                        uso das imagens para o mesmo fim.</p>
                        ...
                        <div class="row py-2">
                            <div class="col d-flex justify-content-center">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td style="font-weight: bold;">Nome do paciente: </td>
                                            <td class="px-2 pt-3"><?php echo $nomepac; ?></td>
                                        </tr>
                                        <tr>
                                            <td style="font-weight: bold;">Assinatura do paciente:</td>
                ...
                <div class="d-print-none d-flex justify-content-center py-5">
                    ...
                    ?>
                        <a href="aprovxiiipac?id=<?php echo $id; ?>&type=reprov">
                        ...
                        <a href="aprovxiiipac?id=<?php echo $id; ?>&type=aprov">
