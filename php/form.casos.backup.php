...
?>
   ...
   <form action="includes/novaprop.inc.php" method="POST" enctype="multipart/form-data">
      ...
      if ($_SESSION["userperm"] == 'Doutor(a)') { ?>
         <div class='d-flex d-block justify-content-around'>
            <div class='form-group d-inline-block flex-fill m-2'>
               <label class='control-label' style='color:black;'>Doutor <b style='color: red;'>*</b></label>
            ...
            <div class='form-group d-inline-block flex-fill m-2'>
               <label class='control-label' style='color:black;'>Nº do Conselho <b style='color: red;'>*</b></label>
         ...
         <div class='d-flex d-block justify-content-around'>
            ...
            <div class='form-group d-none flex-fill m-2' id="outroconvenioDiv">
               <label class='control-label' style='color:black;'>Outro Convênio <b style='color: red;'>*</b></label>
               <input class='form-control' name='outroconvenio' id='outroconvenio' type='text'>
            </div>
         </div>
         <div class='d-flex d-block justify-content-around'>
            <div class='form-group d-inline-block flex-fill m-2'>
               <label class='control-label' style='color:black;'>Distribuidor <b style='color: red;'>*</b></label>
      ...
      if ($_SESSION["userperm"] == 'Distribuidor(a)') { ?>
         ...
         <div class='d-flex d-block justify-content-around'>
            <div class='form-group d-inline-block flex-fill m-2'>
               <label class='control-label' style='color:black;'>Nome <b style='color: red;'>*</b></label>
               <input class='form-control' name='nomeenvio' id='nomeenvio' type='text' required>
               <small>De quem está enviando para dúvidas e devolutivas</small>
            </div>
            <div class='form-group d-inline-block flex-fill m-2'>
               <label class='control-label' style='color:black;'>Celular <b style='color: red;'>*</b></label>
      ...
      ?>
         <div class='d-flex d-block justify-content-around'>
            <div class='form-group d-inline-block flex-fill m-2'>
               <label class='control-label' style='color:black;'>Doutor(a) <b style='color: red;'>*</b></label>
            ...
            <div class='form-group d-inline-block flex-fill m-2'>
               <label class='control-label' style='color:black;'>Nº do Conselho Dr(a)<b style='color: red;'>*</b></label>
         ...
         <div class='d-flex d-block justify-content-around'>
            <div class='form-group d-inline-block flex-fill flex-wrap m-2'>
               <label class='control-label' style='color:black;'>Nome Paciente<b style='color: red;'>*</b></label>
               <input class='form-control' name='nomepaciente' id='nomepaciente' type='text' value="<?php echo $row['usersName']; ?>" required>
               <small>Somente Iniciais</small>
            </div>
            <div class='form-group d-inline-block flex-fill m-2'>
               <label class='control-label'>Convênio <b style='color: red;'>*</b></label>
      ...
      <div class="col-md" style="background-color: #f7f7f7; border-radius: 8px" id="msgExtra" hidden>
      ...
      <div id="container-taxa-extra">
         <!--Taxa Extra-->
         <hr style="border: 2px dashed #ccc;">
         <h4 class="text-conecta">Taxa Extra</h4>

         <div class="p-2">
            <span>Deseja solicitar taxa extra de 20% do valor final para antecipação da data de entrega? <b style="color: red;">*</b></label></span>
            <div class="form-group d-inline-block flex-fill mx-1 py-3 w-100">
               <div class="form-check form-check-inline">
    ...
    <!--TERMO CIÊNCIA - SMARTMOLD-->
      <div id="comunidadosmartmold" hidden>
         <hr style="border: 2px dashed #ccc;">
         <h4 class="text-conecta">COMUNICADO - SMARTMOLD</h4>
         <div class="form-group p-3">
            ...
            <div class="d-flex justify-content-start">
               <div class="form-check form-check-inline p-2">
                  ...
                  <label class="form-check-label" for="termosmartmold">Declaro que li e estou ciente do comunicado <b style="color: red;">*</b></label>
               </div>
            </div>
         </div>
      </div>
      ...
      <!--ENVIO TC-->
      <hr style="border: 2px dashed #ccc;">
      <h4 class="text-conecta">Envio de exames</h4>
                  ...
                  <div class="d-flex justify-content-center p-2 border rounded bg-light">
                     <div>
                        ...
                        <p class="uploader-conecta-button" id="widget2">
                           <input id="laudofile" type="hidden" role="uploadcare-uploader" data-public-key="fe82618d53dc578231ce" data-tabs="file gdrive dropbox" data-multiple="false" data-file-types="pdf" data-input-accept-types="application/pdf" />
                        </p>
                     </div>
                  </div>
