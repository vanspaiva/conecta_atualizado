...
if (!empty($_GET) && isset($_SESSION["useruid"]) && (($_SESSION["userperm"] == 'Qualidade') || ($_SESSION["userperm"] == 'Administrador'))) {
    include("php/head_index.php");
    require_once 'includes/dbh.inc.php';
    require_once 'includes/functions.inc.php';

    $idProjeto = deshashItemNatural(addslashes($_GET['id']));
    if (($_SESSION["userperm"] == 'Administrador') || ($_SESSION["userperm"] == 'Planejador(a)') || ($_SESSION["userperm"] == 'Planej. Ortognática') || ($_SESSION["userperm"] == 'Qualidade')) {
        $permission = true;
    } else {
        $permission = false;
    }
                                    ...
                                    <div class="row d-flex align-items-center">
                                        ...
                                        <div class="col-sm p-2">
                                            ...
                                            <div class="row d-flex align-items-center justify-content-start">
                                                <h4 class="d-flex align-items-center "><?php echo $tipoProd; ?>
                                                    <?php
                                                    if (($permission) && ($_SESSION["userperm"] != 'Qualidade')) {
                                                    ?>
                                                        ...
                                                        <a href="update-plan?id=<?php echo $pedRef; ?>" class="text-conecta"><i class="fa-solid fa-comment-dots"></i></a>
                                                    <?php
                                                    } else {
                                                    ?>
                                                        <a href="dados_proposta?id=<?php echo $pedRef; ?>" class="btn btn-conecta mx-2"><i class="fa-solid fa-info"></i></a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <ul class="nav nav-pills mb-3 d-inline-flex" id="pills-tab-small-pedido" role="tablist">
                                                    ...
                                                    <li class="nav-item" style="margin: auto; width: 40px !important;">
                                                        <a class="nav-link d-flex justify-content-center " id="pills-docs-anvisa-tab" data-toggle="pill" href="#pills-docs-anvisa" role="tab" aria-controls="pills-docs-anvisa" aria-selected="false" style="width: 30px !important; margin: 0px; margin-right: 0px;">
                                                    ...
                                                    <li class="nav-item" style="margin: auto; width: 40px !important;">
                                                        <a class="nav-link d-flex justify-content-center" id="pills-agendar-video-tab" data-toggle="pill" href="#pills-agendar-video" role="tab" aria-controls="pills-agendar-video" aria-selected="true" style="width: 30px !important; margin: 0px; margin-right: 0px;">
                                                    ...
                                                    <li class="nav-item" style="margin: auto; width: 40px !important;">
                                                        <a class="nav-link d-flex justify-content-center" id="pills-aceite-projeto-tab" data-toggle="pill" href="#pills-aceite-projeto" role="tab" aria-controls="pills-aceite-projeto" aria-selected="false" style="width: 30px !important; margin: 0px; margin-right: 0px;">
                                                            <div class="container">
                                                                <div class="row d-flex justify-content-center">
                                                    ...
                                                    <li class="nav-item" style="margin: auto; width: 40px !important;">
                                                        <a class="nav-link d-flex justify-content-center" id="pills-relatorio-tab" data-toggle="pill" href="#pills-relatorio" role="tab" aria-controls="pills-contact" aria-selected="false" style="width: 30px !important; margin: 0px; margin-right: 0px;">
                                                    ...
                                                    <li class="nav-item" style="margin: auto; width: 40px !important;">
                                                        <a class="nav-link d-flex justify-content-center" id="pills-visualizar-projeto-tab" data-toggle="pill" href="#pills-visualizar-projeto" role="tab" aria-controls="pills-visualizar-projeto" aria-selected="false" style="width: 30px !important; margin: 0px; margin-right: 0px;">
                                                                                    ...
                                                                                    <div class="container-fluid justify-content-center align-items-start">
                                                                                        ...
                                                                                        ?>
                                                                                            <div class="row d-flex justify-content-center py-2 my-2">
                                                                                                <span class="btn btn-primary px-2" data-toggle="modal" data-target="#tecicomole"><i class="fas fa-video"></i> Tecido Mole</span>
