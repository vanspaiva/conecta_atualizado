                                        ...
                                        <div class="content-panel">
                                            <table id="table1" class="table table-striped table-advance table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    $ret = mysqli_query($conn, "SELECT * FROM propostas WHERE propStatus IN ('PEDIDO','PRÉ PEDIDO') AND propStatusTC IN ('ANALISAR','REENVIADA') AND propTipoProd = 'ORTOGNÁTICA';");
                                                    $cnt = 1;
                                        ...
                                        <div class="content-panel">
                                            <table id="table2" class="table table-striped table-advance table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    $ret = mysqli_query($conn, "SELECT * FROM propostas WHERE propStatusTC  LIKE '%APROVADA%'  AND propTipoProd = 'ORTOGNÁTICA';");
                                                    while ($row = mysqli_fetch_array($ret)) {
                                                        $ID = $row['propId'];
                                                        $dataCompleta = $row['propDataCriacao'];
                                                        $dataArray = explode(" ", $dataCompleta);
                                            ...
                                            <table id="table3" class="table table-striped table-advance table-hover">
                                                ...
                                                <thead>
                                                 ...
                                                 <tbody>
                                                    ...
                                                    $ret = mysqli_query($conn, "SELECT * FROM propostas WHERE propStatusTC  LIKE '%REPROVADA%' AND propTipoProd = 'ORTOGNÁTICA';");
                                                    while ($row = mysqli_fetch_array($ret)) {
                                                        $ID = $row['propId'];
                                                        $dataCompleta = $row['propDataCriacao'];
                                                        $dataArray = explode(" ", $dataCompleta);
                                        ...
                                        <div class="content-panel">
                                            <table id="table4" class="table table-striped table-advance table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    $ret = mysqli_query($conn, "SELECT * FROM propostas AND propTipoProd = 'ORTOGNÁTICA';");
