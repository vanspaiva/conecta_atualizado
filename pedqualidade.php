                ...
                <div class="row py-4 d-flex justify-content-center">
                    <div class="col-sm-10 justify-content-start" id="titulo-pag">
                        ...
                        <div class="d-flex justify-content-between">
                            <h2 class="text-conecta" style="font-weight: 400;">Lista de <span style="font-weight: 700;">Pedidos</span></h2>
                            <?php
                        ...
                        <div class="card shadow" style="overflow: scroll;">
                            <div class="card-body">
                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link text-tab" id="pills-pendentes-tab" data-toggle="pill" href="#pills-pendentes" role="tab" aria-controls="pills-pendentes" aria-selected="true">Casos Pendentes</a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active text-tab" id="pills-todos-tab" data-toggle="pill" href="#pills-todos" role="tab" aria-controls="pills-todos" aria-selected="false">Todos Casos</a>
                                    </li>
                                </ul>
                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab-small" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link text-tab" id="pills-pendentes-tab" data-toggle="pill" href="#pills-pendentes" role="tab" aria-controls="pills-pendentes" aria-selected="true">
                                            <div class="svg-iten-nav">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="21.899" height="29.45" viewBox="0 0 21.899 29.45">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active text-tab" id="pills-todos-tab" data-toggle="pill" href="#pills-todos" role="tab" aria-controls="pills-todos" aria-selected="false">
                                            <div class="svg-iten-nav">
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="d-flex">
                                                                    ...
                                                                    ?>
                                                                        ...
                                                                        <a href="unitq?id=<?php echo $encrypted;
                                                                                            ?>">
                                    ...
                                    <div class="tab-pane fade" id="pills-pendentes" role="tabpanel" aria-labelledby="pills-pendentes-tab">
