...
if (isset($_SESSION["useruid"]) && (($_SESSION["userperm"] == 'Administrador') || ($_SESSION["userperm"] == 'Doutor(a)') || ($_SESSION["userperm"] == 'Distribuidor(a)') || ($_SESSION["userperm"] == 'Clínica') || ($_SESSION["userperm"] == 'Residente') || ($_SESSION["userperm"] == 'Paciente') || ($_SESSION["userperm"] == 'Dist. Comercial') || ($_SESSION["userperm"] == 'Representante'))) {
                                    ...
                                    <table id="tableProp" class="table table-striped table-advance table-hover">
                                        ...
                                        <?php } else { ?>
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_array($ret)) {
                                                    if (($row['propUserCriacao'] == $_SESSION["useruid"]) || ($row['propDrUid'] == $_SESSION["useruid"])) {
                                                        $dataCompleta = $row['propDataCriacao'];
                                                        $dataArray = explode(" ", $dataCompleta);
                                                        $data = $dataArray[0];
