...
<div class="py-4">
    <div class="row">
        <div class="col-md form-group ">
            <label class='control-label text-black'><b>Imagem referência (um caso bom)</b> <span class="btn text-success px-2" data-toggle="modal" data-target="#verfotosA"><i class="fas fa-images"></i></span></label>
            <div class="d-flex justify-content-center p-2 border rounded bg-light">
                <div>
                    ...
                    <p class="uploader-conecta-button" id="widget1">
                        <input id="tcfile" type="hidden" role="uploadcare-uploader" data-public-key="fe82618d53dc578231ce" data-tabs="file file gdrive dropbox" data-multiple="true" data-images-only="true" data-preview-step="true" data-crop />
                    </p>
                </div>
            </div>
