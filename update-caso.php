<?php
session_start();
if (!empty($_GET) && isset($_SESSION["useruid"]) && (($_SESSION["userperm"] == 'Administrador') || ($_SESSION["userperm"] == 'Planejador(a)') || ($_SESSION["userperm"] == 'Planej. Ortognática')) || $_SESSION["useruid"] == "lenicomercial" || $_SESSION["useruid"] == "lenirodrigues" || $_SESSION["useruid"] == "thaissa" || $_SESSION["useruid"] == "samuel900" ) {
                                                ...
                                                <section class="wrapper">
                                                    ...
                                                    <div class="row pt-4">
                                                        <div class="col">
                                                            <hr>
                                                            <div class="form-row">
                                                                <div class="form-group col-md p-2 d-flex align-items-center flex-row justify-content-center">
                                                                    ...
                                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Alterar data do aceite</button>
                                                                        ...
                                                                        <div class="modal-dialog">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title" id="exampleModalLabel">Alterar data do Aceite</h5>
                                                                                </div>
                                                                                <div class="modal-body">
                                                                                    <form action="alterarDataAceite.php" method="get">
                                                                                        <div class="mb-3">
                                                                                            <label for="recipient-name" class="col-form-label">Informe a data:</label>
                                                                                            <input type="date" class="form-control" id="recipient-data" name="dataAceite" required>
                                                                                        </div>
                                                                                        <div class="mb-3" hidden>
                                                                                            <label for="recipient-name" class="col-form-label">Numero do Pedido:</label>
                                                                                            <input type="text" class="form-control" id="recipient-num" name="numeroPedido"
                                                                                            value="<?php echo $row['pedNumPedido']; ?>" required >
                                                                                        </div>
                                                                                        <div class="mb-3" hidden>
                                                                                            <label for="recipient-name" class="col-form-label">ID do Pedido:</label>
                                                                                            <input type="text" class="form-control" id="recipient-id" name="idPedido"
                                                                                            value="<?php echo $row['pedId']; ?>" required >
                                                                                        </div>
