                                        ...
                                        <div class="row">
                                            <div class="col d-flex justify-content-center">
                                                <div class="p-1">
                                                    ...
                                                    <a href="planejamento" class="text-decoration-none"><button class="btn btn-light hover-bigger" style="color: #ee7624; font-size: 8pt;">Acesse aqui</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card shadow rounded" style="border-left: #FCB805 7px solid;">
                                <div class="card-body">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col">
                                                <h2 style="text-align: center;" class="pt-3"><b><?php echo $counterTCReprovada; ?></b></h2>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-footer d-flex justify-content-center">
                                    <a href="planejamento"><button class="btn btn-sm text-conecta" style="border: 1px #dbdbdb solid;">Ver mais </button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row py-2 my-1">
                        <div class="col">
                            <div class="row d-flex justify-content-start">
                                <h4 class="text-conecta text-center" style="font-weight: 400;">Atividades <b>Planejamento</b></h4>
                            ...
                            <div class="row d-flex justify-content-center align-items-center">
                                ...
                                <a class="text-decoration-none pt-2 px-4" href="gerenciamento-agenda" data-bs-toggle="tooltip" data-bs-placement="top" title="Gerenciamento de Agenda">
                                    <div class="indexCard d-flex justify-content-center align-items-center">
                                        <div class="btn btn-conecta btn-circle shadow p-1 d-flex justify-content-center align-items-center">
                                            <div class="d-flex flex-column justify-content-center align-items-center">
                                                <i class="fas fa-calendar-alt fa-1x" class=" iconesIndex"></i>
                                            </div>
                                        </div>
                                    </div>
                                </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-pedidos" role="tabpanel" aria-labelledby="pills-pedidos-tab">
                                            <div id="table1">
                                                <h6 style="color: #ee7624; font-weight: 400;">Todos Pedidos</h6>
                                                <table id="tablePed" class="table table-striped table-advance table-hover bg-white rounded">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <div class="row py-2">
                                                            ...
                                                            $ret = mysqli_query($conn, "SELECT * FROM pedido WHERE pedAndamento='ABERTO' AND NOT pedStatus='PROD' ORDER BY pedDtCriacaoPed DESC;");
                                        ...
                                        <div class="tab-pane fade" id="pills-propostas" role="tabpanel" aria-labelledby="pills-propostas-tab">
                                            <div id="table2">
                                                <h6 style="color: #ee7624; font-weight: 400;">Todas Propostas</h6>
