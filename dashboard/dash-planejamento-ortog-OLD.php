                            ...
                            <div class="card shadow rounded" style="border-left: #FCB805 7px solid;">
                                <div class="card-body">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col">
                                                <h2 style="text-align: center;" class="pt-3"><b><?php echo $counterPedidoPendente; ?></b></h2>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <table id="tablePed" class="table table-striped table-advance table-hover bg-white rounded">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <div class="row py-2">
                                                            ...
                                                            $ret = mysqli_query($conn, "SELECT * FROM pedido WHERE pedAndamento='ABERTO' AND pedTipoProduto='ORTOGNÁTICA' AND NOT pedStatus='PROD' ORDER BY pedDtCriacaoPed DESC;");
                                        ...
                                        <div class="tab-pane fade" id="pills-propostas" role="tabpanel" aria-labelledby="pills-propostas-tab">
                                            <div id="table2">
                                                <h6 style="color: #ee7624; font-weight: 400;">Propostas</h6>
                                                <table id="tableProp" class="table table-striped table-advance table-hover bg-white rounded">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        require_once 'includes/dbh.inc.php';
                                                        $ret = mysqli_query($conn, "SELECT * FROM propostas WHERE propTipoProd=ORTOGNÁTICA AND propStatusTC  LIKE '%REPROVADA%'");
