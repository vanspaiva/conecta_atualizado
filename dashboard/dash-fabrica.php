                    ...
                    <div class="card-body">
                        ...
                        <div id="div-dash-dinamic2">
                            ...
                            <div class="card-footer d-flex justify-content-center bg-white h-auto">
                                <?php $encrypted = hashItemNatural($lastPed); ?>
                                <a href="relatorio?id=<?php echo $encrypted; ?>"><button class="btn btn-sm text-conecta" style="border: 1px #dbdbdb solid;">Ver esse pedido </button></a>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills mb-3 px-2" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active text-tab" id="pills-abertos-tab" data-toggle="pill" href="#pills-abertos" role="tab" aria-controls="pills-abertos" aria-selected="true">Atuais</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link text-tab" id="pills-proximo-tab" data-toggle="pill" href="#pills-proximo" role="tab" aria-controls="pills-proximo" aria-selected="true">Próximos</a>
                            </li>
                            <li class="nav-item" role="presentation">
                        ...
                        <ul class="nav nav-pills mb-3 px-2" id="pills-tab-small" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active text-tab" id="pills-abertos-tab" data-toggle="pill" href="#pills-abertos" role="tab" aria-controls="pills-abertos" aria-selected="true">
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link text-tab" id="pills-proximo-tab" data-toggle="pill" href="#pills-proximo" role="tab" aria-controls="pills-proximo" aria-selected="true">
                                    <div class="svg-iten-nav">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="21.899" height="29.45" viewBox="0 0 21.899 29.45">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-abertos" role="tabpanel" aria-labelledby="pills-abertos-tab">
                                <h5 style="padding-top: 20px !important;" class="text-dark-gray" id="titulo-tab-small">Casos Atuais</h5>
                                <p style="color: silver;">Aqui você encontrará todos os casos designados para a Fábrica</p>
                                    ...
                                    <table id="tableAberto" class="table table-striped table-advance table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <div class="row py-2">
                                                ...
                                                $ret = mysqli_query($conn, "SELECT * FROM pedido WHERE pedStatus = 'PROD'");
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="d-flex">
                                                            ...
                                                            ?>
                                                            <a href="relatorio?id=<?php echo $encrypted; ?>">
                            ...
                            <div class="tab-pane fade" id="pills-proximo" role="tabpanel" aria-labelledby="pills-proximo-tab">
                                <h5 style="padding-top: 20px !important;" class="text-dark-gray" id="titulo-tab-small">Casos Próximos</h5>
                                <p style="color: silver;">Estes casos serão designados à Fábrica a seguir. Verifique a disponibilidade para realizá-los.</p>
                                    ...
                                    <table id="tablePendente" class="table table-striped table-advance table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <div class="row py-2">
                                                ...
                                                <?php
                                                //chamar do banco de dados todos os casos
                                                $ret = mysqli_query($conn, "SELECT * FROM pedido WHERE NOT pedStatus = 'PROD' AND NOT pedStatus = 'ENVIADO'");
                                                while ($row = mysqli_fetch_array($ret)) {
                                                    $userCriador = $row['pedUserCriador'];
                                                    $propID = $row['pedPropRef'];
                                                    $pedID = $row['pedNumPedido'];
                                    ...
                                    <table id="tableFinalizado" class="table table-striped table-advance table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <div class="row py-2">
                                                ...
                                                <?php
                                                //chamar do banco de dados todos os casos
                                                $ret = mysqli_query($conn, "SELECT * FROM pedido WHERE pedStatus = 'ENVIADO'");
                                                while ($row = mysqli_fetch_array($ret)) {
                                                    $userCriador = $row['pedUserCriador'];
                                                    $propID = $row['pedPropRef'];
                                                    $pedID = $row['pedNumPedido'];
