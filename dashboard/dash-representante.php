...
require_once "graficosrep/pizza-chart.php";
require_once "graficosrep/line-chart.php";
require_once "counterHelpers/counterRep.php";

$values_line = get_values_line($conn);
$options_line = get_options_line($conn);

$valorPropostasTotal = number_format(soma_rep_valores_propostas($conn), 2, ",", ".");
        ...
        <div class="row d-flex align-items-center mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div id="div-dash-dinamic1">
                            ...
                            <div class="card-footer d-flex justify-content-center bg-white h-auto">
                                <a href="dados_proposta?id=<?php echo $lastProp; ?>"><button class="btn btn-sm text-conecta" style="border: 1px #dbdbdb solid;">Ver essa proposta </button></a>
                            </div>
                        </div>
                        <div id="div-dash-dinamic2" class="d-none">
                            ...
                            <div class="card-footer d-flex justify-content-center bg-white h-auto">
                                <a href="dados_proposta?id=<?php echo $lastPedNumProp; ?>"><button class="btn btn-sm text-conecta" style="border: 1px #dbdbdb solid;">Ver esse pedido </button></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-8 d-flex justify-content-center align-items-center">
                <div class="container-fluid p-1">
                    ...
                    <div class="row d-flex justify-content-center align-items-center">
                        <div class="col p-1">
                            <div class="card shadow rounded" style="border-left: #2eacd1 7px solid;">
                                ...
                                <div class="card-footer d-flex justify-content-center">
                                    <a href="solicitacoes"><button class="btn btn-sm text-conecta" style="border: 1px #dbdbdb solid;">Ver mais </button></a>
                        ...
                        <div class="col p-1">
                            <div class="card shadow rounded" style="border-left: #00AB30 7px solid;">
                                ...
                                <div class="card-footer d-flex justify-content-center">
                                    <a href="pedidosclientes"><button class="btn btn-sm text-conecta" style="border: 1px #dbdbdb solid;">Ver mais </button></a>
                                </div>
                            </div>
                                    ...
                                    <div class="container-fluid text-center">
                                        <div class="row">
                                            <div class="col d-flex justify-content-center">
                                                <div class="p-1">
                                                    <h4 class="text-white" style="text-align: center; font-size: 10pt;"><i class="fas fa-people-arrows"></i> Minha Lista de Clientes</h4>
                                                    <a href="usuariosrepresentante" class="text-decoration-none"><button class="btn btn-light hover-bigger" style="color: #ee7624; font-size: 8pt;">Acesse aqui</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row pt-3">
                        <h4 class="text-conecta" style="font-weight: 400;">Atividades Representante</h4>
                        <hr style="border-color: #ee7624;">
                    </div>
                    <div class="row d-flex justify-content-center align-items-center">
                        <a class="text-decoration-none pt-2 px-4" href="usuariosrepresentante" data-bs-toggle="tooltip" data-bs-placement="top" title="Lista Clientes">
                            <div class="indexCard d-flex justify-content-center align-items-center">
                                <div class="btn btn-conecta btn-circle shadow p-1 d-flex justify-content-center align-items-center">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <i class="fas fa-users fa-1x mr-1" class="iconesIndex"></i>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a class="text-decoration-none pt-2 px-4" href="solicitacoes" data-bs-toggle="tooltip" data-bs-placement="top" title="Solicitações Clientes">
                            <div class="indexCard d-flex justify-content-center align-items-center">
                                <div class="btn btn-conecta btn-circle shadow p-1 d-flex justify-content-center align-items-center">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <a class="text-decoration-none pt-2 px-4" href="financeirocomercial" data-bs-toggle="tooltip" data-bs-placement="top" title="Financeiro">
                            <div class="indexCard d-flex justify-content-center align-items-center">
                                <div class="btn btn-conecta btn-circle shadow p-1 d-flex justify-content-center align-items-center">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <i class="fas fa-comment-dollar fa-1x mr-1" class="iconesIndex"></i>
                        ...
                        <a class="text-decoration-none pt-2 px-4" href="pedidosantecipacao" data-bs-toggle="tooltip" data-bs-placement="top" title="Antecipação">
                            <div class="indexCard d-flex justify-content-center align-items-center">
                                <div class="btn btn-conecta btn-circle shadow p-1 d-flex justify-content-center align-items-center">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <a class="text-decoration-none pt-2 px-4" href="planejamentocomercial" data-bs-toggle="tooltip" data-bs-placement="top" title="Análise de TC">
                            <div class="indexCard d-flex justify-content-center align-items-center">
                                <div class="btn btn-conecta btn-circle shadow p-1 d-flex justify-content-center align-items-center">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <a class="text-decoration-none pt-2 px-4" href="pedidosclientes" data-bs-toggle="tooltip" data-bs-placement="top" title="Planejamento de Casos">
                            <div class="indexCard d-flex justify-content-center align-items-center">
                                <div class="btn btn-conecta btn-circle shadow p-1 d-flex justify-content-center align-items-center">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div id="table1">
                            ...
                            <table id="tableProp" class="table table-striped table-advance table-hover bg-white rounded">
                                ...
                                <tbody style="background-color: white;">
                                    ...
                                    $ret = mysqli_query($conn, "SELECT * FROM propostas WHERE propStatus LIKE '%PENDENTE%' AND propRepresentante = '" . $_SESSION["useruid"] . "'");
