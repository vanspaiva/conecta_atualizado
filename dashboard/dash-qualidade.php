        ...
        <div class="row d-flex align-items-center mb-4">
                ...
                <div class="card shadow rounded" style="border-top: #ee7624 7px solid;">
                    <div class="card-body">
                        ...
                        <div id="div-dash-dinamic2" class="d-none">
                            ...
                            <div class="card-footer d-flex justify-content-center bg-white h-auto">
                                <a href="update-proposta?id=<?php echo $lastPedNumProp; ?>"><button class="btn btn-sm text-conecta" style="border: 1px #dbdbdb solid;">Ver esse pedido </button></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-8 d-flex justify-content-center align-items-center">
                <div class="container-fluid p-1">
                                    ...
                                    <div class="container-fluid text-center">
                                        <div class="row">
                                            <div class="col d-flex justify-content-center">
                                                <div class="p-1">
                                                    <h4 class="text-white" style="text-align: center; font-size: 10pt;"><i class="fas fa-list"></i> Lista de Propostas Comerciais</h4>
                                                    <a href="comercial" class="text-decoration-none"><button class="btn btn-light hover-bigger" style="color: #ee7624; font-size: 8pt;">Acesse aqui</button></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row pt-3">
                        <h4 class="text-conecta" style="font-weight: 400;">Atividades Qualidade</h4>
                        <hr style="border-color: #ee7624;">
                    </div>
                    <div class="row d-flex justify-content-center align-items-center">

                        <a class="text-decoration-none pt-2 px-4" href="produtos" data-bs-toggle="tooltip" data-bs-placement="top" title="Produtos">
                            <div class="indexCard d-flex justify-content-center align-items-center">
                                <div class="btn btn-conecta btn-circle shadow p-1 d-flex justify-content-center align-items-center">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <i class='fas fa-boxes fa-1x mr-1' class="iconesIndex"></i>
                                    </div>
                                </div>
                            </div>
                        </a>

                        <a class="text-decoration-none pt-2 px-4" href="qualificacaocliente" data-bs-toggle="tooltip" data-bs-placement="top" title="Qualificação Cliente">
                            <div class="indexCard d-flex justify-content-center align-items-center">
                                <div class="btn btn-conecta btn-circle shadow p-1 d-flex justify-content-center align-items-center">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <i class="fas fa-flag fa-1x mr-1" class="iconesIndex"></i>
                                    </div>
                                </div>
                            </div>
                        </a>

                        <a class="text-decoration-none pt-2 px-4" href="laudos" data-bs-toggle="tooltip" data-bs-placement="top" title="Laudos Tomograficos">
                            <div class="indexCard d-flex justify-content-center align-items-center">
                                <div class="btn btn-conecta btn-circle shadow p-1 d-flex justify-content-center align-items-center">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <i class="fas fa-file-contract fa-1x mr-1" class="iconesIndex"></i>
                                    </div>
                                </div>
                            </div>
                        </a>

                        <a class="text-decoration-none pt-2 px-4" href="documentos" data-bs-toggle="tooltip" data-bs-placement="top" title="Documentos Anvisa">
                            <div class="indexCard d-flex justify-content-center align-items-center">
                                <div class="btn btn-conecta btn-circle shadow p-1 d-flex justify-content-center align-items-center">
                                    <div class="d-flex flex-column justify-content-center align-items-center">
                                        <i class="fas fa-file-alt fa-1x" class=" iconesIndex"></i>
                                    </div>
                                </div>
                            </div>
                        </a>
                ...
                <div class="card shadow rounded" style="overflow: scroll;">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-warning btn-xs"><i class="far fa-file-pdf"></i></button></a> -->
                                                <?php if (($_SESSION["userperm"] == 'Administrador') || ($_SESSION["useruid"] == 'daiane')) { ?>
