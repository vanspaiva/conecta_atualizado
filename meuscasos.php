...
if (isset($_SESSION["useruid"])) {
    ...
    //     $query = '($userSessionIdentifier == $cpfcnpj)';
    // } else if($_SESSION["userperm"] == 'Dist. Comercial'){
    //     $query = '($userSessionIdentifier == $cpfcnpj)';
    // } else if($_SESSION["userperm"] == 'Doutor(a)'){
    //     $query = '($_SESSION["useruid"] == $userCriador)';
    // } else{
    //     $query = 'true';
    // }

    if ($_SESSION["usercpf"] == null) {
        $userSessionIdentifier = $_SESSION["usercnpj"];
    } else {
        $userSessionIdentifier = $_SESSION["usercpf"];
    }
?>
                    ...
                    <div class="col-sm-10">
                        <div class="d-flex">
                            ...
                            <div class="col-sm-11 pt-2 row-padding-2">
                                <div class="row px-3">
                                    <h2 class="text-conecta" style="font-weight: 400;">Meus <span style="font-weight: 700;">Casos</span></h2>
                                </div>
                            </div>
                        </div>
