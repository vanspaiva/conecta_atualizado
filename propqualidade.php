            ...
            <div class="container-fluid">
                <div class="row py-4 d-flex justify-content-center">
                    <div class="col-sm" id="titulo-pag">
                        <h2 class="text-conecta" style="font-weight: 400;">Lista de <span style="font-weight: 800;"> Propostas</span></h2>
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                            <li class="nav-item px-3" role="presentation">
                                                <a class="nav-link text-tab" id="pills-analisar-tab" data-toggle="pill" href="#pills-analisar" role="tab" aria-controls="pills-analisar" aria-selected="true">Analisar</a>
                                            </li>
                                            <li class="nav-item px-3" role="presentation">
                                                <a class="nav-link active text-tab" id="pills-todas-propostas-tab" data-toggle="pill" href="#pills-todas-propostas" role="tab" aria-controls="pills-todas-propostas" aria-selected="true">Todas</a>
                                            </li>
                                            <li class="nav-item px-3" role="presentation">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <ul class="nav nav-pills mb-3 " id="pills-tab-small" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link d-flex justify-content-center text-tab" id="pills-analisar-tab" data-toggle="pill" href="#pills-analisar" role="tab" aria-controls="pills-analisar" aria-selected="true">Analisar</a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link d-flex justify-content-center active text-tab" id="pills-todas-propostas-tab" data-toggle="pill" href="#pills-todas-propostas" role="tab" aria-controls="pills-todas-propostas" aria-selected="true">Todas</a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link d-flex justify-content-center text-tab" id="pills-enviadas-tab" data-toggle="pill" href="#pills-enviadas" role="tab" aria-controls="pills-enviadas" aria-selected="true">Enviadas</a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link d-flex justify-content-center text-tab" id="pills-prepedido-tab" data-toggle="pill" href="#pills-prepedido" role="tab" aria-controls="pills-prepedido" aria-selected="false">Pré Pedido</a>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <a class="nav-link d-flex justify-content-center text-tab" id="pills-aprovadas-tab" data-toggle="pill" href="#pills-aprovadas" role="tab" aria-controls="pills-aprovadas" aria-selected="false">Aprovadas</a>
                                            </li>
                                        </ul>
                                    </div>

                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade" id="pills-analisar" role="tabpanel" aria-labelledby="pills-analisar-tab">
                                        ...
                                        <div class="tab-pane fade show active" id="pills-todas-propostas" role="tabpanel" aria-labelledby="pills-todas-propostas-tab">
