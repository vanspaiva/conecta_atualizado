                                            ...
                                            <div class="col">
                                                <div class="content-panel">
                                                    <form class="form-horizontal style-form" name="form1" action="includes/propaceite.inc.php" method="post" enctype="multipart/form-data">
                                                        ...
                                                        <div class="d-flex d-block justify-content-around align-items-top">
                                                            <div class="col-md form-group">
                                                                <p>OBS - Empresa correio não transporta produto devido ao valor ( não tem seguro)</p>
                                                                <h5>Produto: <?php echo $TipoProduto;?></h5>
                                                                <p> <?php echo mostrarPesoProduto($TipoProduto);?></p>
                                                            </div>
                                                        </div>
                                                        <div class="d-flex d-block justify-content-around align-items-top">
                                                            <div class="col-md form-group">
                                                                <label class="form-label text-black" for="transporte">Meio de Transporte <b style="color: red;">*</b></label>
                                                                <select class="form-control" id="transporte" name="transporte" required>
                                                                    <option value="">Escolha uma opção</option>
                                                                    <?php
                                                                    $retPgto = mysqli_query($conn, "SELECT * FROM transportemodal ORDER BY NomeModal ASC;");
                                                                    while ($rowPgto = mysqli_fetch_array($retPgto)) {
                                                                    ?>
                                                                        <option value="<?php echo $rowPgto['ModalID']; ?>"> <?php echo $rowPgto['NomeModal']; ?></option>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                            ...
                                                            <div class="col-md form-group">
                                                                <label class="form-label text-black" for="observacoes">Observações </label>
