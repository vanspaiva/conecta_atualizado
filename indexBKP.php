                ...
                <div class="row d-flex align-items-end mb-4">
                    ...
                    ?>
                        <div class="col d-flex justify-content-center align-items-center">
                            <div class="container-fluid">
                                <div class="row">
                                    <h4 class="text-conecta" style="font-weight: bold;">Dados Rápidos <a href="index" style="color: #ee7624;"><i class="fas fa-chevron-left"></i></a> </h4>
                                </div>
                                        ...
                                        <div class="card shadow rounded" style="border-left: #2eacd1 7px solid;">
                                            <div class="card-body">
                                                ...
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col">
                                                            <!--<h6 style="color: #2eacd1; text-align: center;">Número de Propostas</h6>-->
                                                            <h4 style="text-align: center;" class="pt-3"><b>25</b></h4>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="col d-flex justify-content-center align-items-center">
                            <div class="container-fluid p-1">
                                ...
                                <div class="row d-flex justify-content-center align-items-center">
                                    ...
                                    <div class="col p-1">
                                        <div class="card shadow rounded" style="background-color: #ee7624; height: 190px;">
                                            <div class="card-body h-auto d-flex justify-content-center align-items-center">
                                                <div class="container-fluid text-center">
                                                    <div class="row">
                                                        <div class="col d-flex justify-content-center">
                                                            <div class="p-1">
                                                                <h4 class="text-white" style="text-align: center; font-size: 14pt;"><i class="fas fa-plus"></i> Nova Solicitação de Proposta</h4>
                                                                <a href="solicitacao" class="text-decoration-none"><button class="btn btn-light hover-bigger" style="color: #ee7624; font-size: 10pt;">Acesse aqui</button></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
