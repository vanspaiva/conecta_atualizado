                ...
                <div class="row py-4 d-flex justify-content-center">
                    <div class="col-sm-10 justify-content-start" id="titulo-pag">
                        ...
                        <div class="d-flex justify-content-between d-print-none">
                            <h2 class="text-conecta" style="font-weight: 400;"> Propostas e Pedidos - <span style="font-weight: 700;">
                                    Qualidade </span></h2>
                        ...
                        <div class="container-fluid card shadow" style="overflow: scroll;">
                            <div class="row py-4">
                                <div class="col d-flex justify-content-around align-items-center">
                                    <a href="propqualidade"><button type="submit" class="btn btn-conecta">Lista de Propostas</button></a>
                                </div>
                            </div>

                            <div class="row py-4">
                                <div class="col d-flex justify-content-around align-items-center">
                                    <a href="pedqualidade"><button type="submit" class="btn btn-conecta">Lista de Pedidos</button></a>
                                </div>
                            </div>
